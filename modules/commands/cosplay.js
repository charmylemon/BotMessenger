  module.exports.config = {
    ...
    description: "Xem ảnh cosplay (trừ 50.000)",
  ...
  module.exports.run = async ({ api, event, Currencies }) => {
    ...
    if (userMoney < 50000) {
      return api.sendMessage("⚠️ Bạn không đủ 50.000 để xem ảnh cosplay!", event.threadID, event.messageID);
    }
    await Currencies.setData(event.senderID, { money: userMoney - 50000 });
    ...
    let callback = function () {
      return api.sendMessage({
        body: `📸 Ảnh cosplay\n💸 Đã trừ 50.000\n💰 Số dư còn lại: ${(userMoney - 50000).toLocaleString()} VNĐ`,
        attachment: [
