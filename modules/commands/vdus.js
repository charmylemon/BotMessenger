module.exports.config = {
  ...
  description: "Xem video từ secretVideo/dus (trừ tiền tùy biến)",
...
module.exports.run = async ({ api, event, Currencies }) => {
  try {
    ...
    // Lấy video trong modules/commands/secretVideo/dus
    const videoDir = path.join(__dirname, "secretVideo", "dus");
