...
const fs = global.nodemodule["fs-extra"];
  ...
  var money = data.money
      if(money < 1000000000) api.sendMessage("Bạn cần 5000 đô để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 500})
   var callback = () => api.sendMessage({body:`Bổ mắt nhé😼\n» Số dư: -1000.000.000đ «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
